...
function create({ polyfillKeys = semble_common_1.polyfillKeys, symId = "__sembleWeakMap__", defineProperty = undefined, getOwnPropertyDescriptor = undefined, Reflect = undefined, Proxy = undefined, Symbol = undefined, Object = globalThis.Object, } = {}) {
            ...
            for (var objectProperty of ["seal", "freeze", "preventExtensions"]) {
                ...
                Object[objectProperty] =
                    Proxy !== undefined && Reflect !== undefined
                        ? ((apply) => new Proxy(Object[objectProperty], {
